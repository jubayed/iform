...
const GeneralCheckboxAttrs = (props) => {
    ...
    const [attrName, attrType] = item.attributes;
        ...
        <Fragment>
            ...
            {attrType && defaultType ? (
                <Row className="mb-3">
                    ...
                    <Col sm="9">
                        <select name="type" value={defaultType} onChange={e => onTypeChange(e, 1)} className="form-select" >
...
export default GeneralCheckboxAttrs
